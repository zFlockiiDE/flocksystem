...
public class ServerLockCommand extends SimpleSubCommand {
	...
	protected void onCommand() {
		...
		RedisManager.getJedis().srem("available-server", target.getName().toLowerCase());

		Common.tell(player, "Der Server " + target.getName() + " wurde gesperrt.");
	}
